...
import com.zebrunner.agent.core.registrar.RerunCondition;
import com.zebrunner.agent.core.client.domain.AuthTokenDTO;
...
public class ZebrunnerApiClient {
    ...
    public void uploadArtifact(InputStream artifact, String name, Long testRunId, Long testId) {
    ...
    public TestSessionDTO updateSession(Long testRunId, TestSessionDTO testSession) {
